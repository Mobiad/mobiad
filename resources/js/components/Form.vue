  ...
  <div v-else>
    <div class="row justify-content-center">
      ...
      <div class="col-md-5">
        ...
        <b-card style="margin-top: 2em; background-color: #ecf3f8"   >
          <h4 style="margin-bottom: 0.5em; color: #4484bc; font-weight: lighter"> Tigo Pesa Payment </h4>
          ...
          <p style="font-weight: lighter">You will be prompted to enter your tigopesa password inorder to complete payment</p>
